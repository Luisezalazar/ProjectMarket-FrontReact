                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent" ref={collapseRef} >
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <NavLink to='/customers' className="nav-link active d-flex bold" onClick={handleNavItemClick}><span>👤</span><span>Customers</span></NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink to='/products' className="nav-link active d-flex bold" onClick={handleNavItemClick}><span>🔧</span><span>Products</span></NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink to='/orders' className="nav-link active d-flex bold" onClick={handleNavItemClick}>Order</NavLink>
                        </li>
                        <li className="nav-item">
